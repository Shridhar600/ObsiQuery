...
def retrieve_notes_tool(query: str):
    """
    ...
    query_filters: VectorSearchOutputSchema = get_vector_search_filters_from_llm(query)
...
def get_vector_search_filters_from_llm(query) -> VectorSearchOutputSchema :
    """
