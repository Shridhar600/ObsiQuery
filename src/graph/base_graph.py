...
def create_simple_graph(llm_with_tools, memory, tools: list ) -> CompiledStateGraph:
    ...
    )  # The tools_condition function exposes two edges for the agent_node Node 1. tools 2. END.
